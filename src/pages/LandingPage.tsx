  ...
  const roadmapData = [
    {
      ...
      description: "Core platform development and initial features - CURRENT",
      items: [
    ...
    },
    {
      ...
      description: "Essential trading capabilities and market pairs",
      items: [
        "ETH, BTC, SOL trading pairs",
    ...
    },
    {
      ...
      description: "Enhanced trading tools and user experience",
      items: [
    ...
    },
    {
      ...
      description: "Scaling and additional features",
      items: [
        "More trading pairs",
        "Cross-chain support",
        "Enhanced liquidity",
    ...
    },
    {
      ...
      description: "Mobile app and comprehensive analytics",
      items: [
        "Native mobile app",
    ...
    },
    {
      ...
      description: "Enterprise features and institutional tools",
      items: [
          ...
          <div className="w-full flex flex-col lg:flex-row gap-12 lg:gap-20 relative z-10">
            <motion.div className="flex flex-col gap-8" variants={container}>
              ...
              <motion.h2
                ...
                variants={item}
              >
                Building the future of decentralized trading - Join us on our journey
                to create a next-generation trading platform
              </motion.h2>
            ...
            >
              ...
              >
                ...
                <div className="text-base font-normal mt-2 opacity-70">
                  ETH, BTC, SOL with up to 100x leverage (Coming Soon)
                </div>
              </motion.div>
              <motion.div
                className="backdrop-blur-sm p-8 rounded-2xl text-xl font-bold w-full lg:w-[400px]"
              ...
              >
                In Development
                <div className="text-base font-normal mt-2 opacity-70">
                  Building ultra-fast trading infrastructure
                </div>
              </motion.div>
            </motion.div>
          </div>
              ...
              {roadmapData.map((milestone, index) => (
                ...
                >
                  <div
                    ...
                    style={{
                      borderColor: milestone.status === "completed" || milestone.status === "current"
                        ? 'transparent'
                        : 'rgba(94, 129, 172, 0.3)',
